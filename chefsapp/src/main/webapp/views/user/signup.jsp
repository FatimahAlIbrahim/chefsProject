...
<form action="${appName}user/signup" method="post">
	...
	<div class="mb-3">
		<label class="form-label colorTwo">Picture URL</label> 
		<input id="pictureUrlUser" type="text" name="picture" class="form-control" required>
	</div>
	
	<div class="mb-3">
		<label class="form-label colorTwo">First Name</label>
		<input name="firstName" type="text" class="form-control" required>
	</div>

	<div class="mb-3">
		<label class="form-label colorTwo">Last Name</label>
		<input name="lastName" type="text" class="form-control" required>
	</div>
	
	<div class="mb-3">
		<label class="form-label colorTwo">Email Address</label>
		<input name="emailAddress" type="email" class="form-control" required>
	</div>
	
	<div class="mb-3">
		<label class="form-label colorTwo">Password</label>
